...
//! This condition variable is designed to work with named_upgradable_mutex and
...
class named_condition
{
   ...
   //!Releases the lock on the named_upgradable_mutex object associated with lock, blocks
   ...
   struct condition_holder
   {
      ...
      //If named_upgradable_mutex is implemented using semaphores
   ...
   {
      //named_condition only works with named_upgradable_mutex
      BOOST_STATIC_ASSERT((detail::is_convertible<typename Lock::mutex_type&, named_upgradable_mutex&>::value == true));
